...
const Sports = () => {
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="relative h-[60vh] bg-gray-50 dark:bg-gray-900 flex flex-col justify-center px-4 sm:px-6 lg:px-8 overflow-hidden pt-20 border-b border-gray-200/50 dark:border-gray-800/50">
